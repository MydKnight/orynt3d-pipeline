...
- Known gap-report noise: Loot Studios had months with no release (2021-04, 2022-07/08/10/11, 2024-01/02); `getGaps` can't distinguish "creator skipped" from "not imported" so those show as false gaps. A skip marker is a possible future add.
...
4. **Gap-report skip marker** — optional: let a release be marked "creator skipped" so `getGaps` stops flagging known-empty months (Loot Studios 2021-04, 2022-07/08/10/11, 2024-01/02).
