...
1. **Archvillain live re-run** — `npm run sync` (or re-run `npm run pipeline`) to finish Empire of Sands on the resilient writer, then work the Dec 2025+ backlog. Acceptance test #1 in `docs/resilient-nas-write-spec.md` is exactly this.
